...
class _IdentityApi implements IdentityApi {
  _IdentityApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<RegistrationResponseDto> register(RegisterRequestDto request) async {
