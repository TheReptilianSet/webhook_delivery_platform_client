...
class _OrganizationsApi implements OrganizationsApi {
  ...
  Future<OrganizationPageDto> listOrganizations({
    ...
    final _options = _setStreamType<OrganizationPageDto>(
    ...
    late OrganizationPageDto _value;
    try {
      _value = OrganizationPageDto.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<MemberPageDto> listMembers(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<MemberPageDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late MemberPageDto _value;
    try {
      _value = MemberPageDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<void> deleteMember(String organizationId, String userId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
